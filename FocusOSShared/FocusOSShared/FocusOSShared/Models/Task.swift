...
public final class Task {
    ...
    // External reminder tracking
    public var externalReminderId: String? // EKReminder.calendarItemIdentifier
    public var externalReminderListId: String? // EKCalendar.calendarIdentifier
    public var externalSource: String? // "apple_reminders", "google_tasks", etc.
    ...
    public init(
        ...
        self.updatedAt = Date()
        self.dependsOnIds = []
        self.externalReminderId = nil
        self.externalReminderListId = nil
