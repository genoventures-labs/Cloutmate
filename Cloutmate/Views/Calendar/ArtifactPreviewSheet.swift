...
struct ArtifactPreviewSheet: View {
    ...
    @Binding var artifact: CloutmateShared.Artifact?
    ...
    private func artifactContent(_ artifact: CloutmateShared.Artifact) -> some View {
        NavigationStack {
            Form {
    ...
    private func titleSection(_ artifact: CloutmateShared.Artifact) -> some View {
        Section("Title") {
    ...
    private func contentSection(_ artifact: CloutmateShared.Artifact) -> some View {
        Section("Content") {
    ...
    private func formatSection(_ artifact: CloutmateShared.Artifact) -> some View {
    ...
    private func stateSection(_ artifact: CloutmateShared.Artifact) -> some View {
        Section("State") {
    ...
    @ViewBuilder
    private func publishedSection(_ artifact: CloutmateShared.Artifact) -> some View {
    ...
    @ViewBuilder
    private func mediaSection(_ artifact: CloutmateShared.Artifact) -> some View {
    ...
    @ViewBuilder
    private func tagsSection(_ artifact: CloutmateShared.Artifact) -> some View {
...
#Preview {
    ArtifactPreviewSheet(artifact: .constant(CloutmateShared.Artifact(title: "Test Artifact", content: "Test content", outputFormat: .brief)))
