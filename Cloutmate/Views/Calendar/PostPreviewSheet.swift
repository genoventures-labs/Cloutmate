...
struct PostPreviewSheet: View {
    ...
    @Binding var post: CloutmateShared.Post?
    ...
    private func postContent(_ post: CloutmateShared.Post) -> some View {
        NavigationStack {
            Form {
                captionSection(post)
    ...
    private func captionSection(_ post: CloutmateShared.Post) -> some View {
        Section("Caption") {
            Text(post.caption)
    ...
    @ViewBuilder
    private func scheduleSection(_ post: CloutmateShared.Post) -> some View {
    ...
    @ViewBuilder
    private func publishedSection(_ post: CloutmateShared.Post) -> some View {
    ...
    private func statusSection(_ post: CloutmateShared.Post) -> some View {
        Section("Status") {
    ...
    @ViewBuilder
    private func engagementSection(_ post: CloutmateShared.Post) -> some View {
    ...
    @ViewBuilder
    private func mediaSection(_ post: CloutmateShared.Post) -> some View {
    ...
    @ViewBuilder
    private func tagsSection(_ post: CloutmateShared.Post) -> some View {
