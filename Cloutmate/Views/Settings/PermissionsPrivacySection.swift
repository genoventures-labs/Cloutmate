...
struct PermissionsPrivacySection: View {
        ...
        AVCaptureDevice.requestAccess(for: .audio) { granted in
            DispatchQueue.main.async {
                if granted {
                    ...
                    microphoneStatus = .denied
                    alertMessage = "Microphone access denied.\n\nTo enable: System Settings → Privacy & Security → Microphone → Enable Cloutmate"
    ...
    private func resetAllPermissions() {
        ...
        This will reset the permission state for Cloutmate. You'll need to:
        
        1. Go to System Settings → Privacy & Security
        2. Remove Cloutmate from Microphone, Speech Recognition, and other permission lists
        3. Restart Cloutmate
        ...
        if response == .alertFirstButtonReturn {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                ...
                3. Find and remove Cloutmate from each list (if present)
                4. Restart Cloutmate
