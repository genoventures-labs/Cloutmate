...
struct ProjectInsightsView: View {
    ...
    @State private var selectedProject: FocusOSShared.Project?
...
struct ProjectDetailInsightsSheet: View {
    ...
    var projectPosts: [FocusOSShared.Post] {
...
#Preview {
    ProjectInsightsView()
        .modelContainer(for: [FocusOSShared.Project.self, FocusOSShared.Post.self, FocusOSShared.Task.self, InsightSnapshot.self])
}
