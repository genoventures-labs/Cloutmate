...
struct SettingsView: View {
    ...
    @State private var showIntegrationsDrawer = false
    ...
    var body: some View {
        ...
        .overlay(alignment: .trailing) {
            if showIntegrationsDrawer {
                IntegrationsDrawer(isPresented: $showIntegrationsDrawer)
...
private extension SettingsView {
    var headerView: some View {
        V2GlassHeaderBar(
            title: "Settings",
            subtitle: "Tune FocusOS’s workspace to match your flow.",
            trailingAccessory: {
    ...
    var selectedContent: some View {
        VStack(alignment: .leading, spacing: 28) {
            ...
            case .notion:
                // Notion integration is now managed through IntegrationsDrawer
                EmptyView()
            case .integrations:
    ...
    var integrationsControls: some View {
        V2GlassControlStack(spacing: 18) {
            Text("Connect your favorite tools and services to sync data, import projects, and streamline your workflow.")
                .font(.footnote)
                .foregroundStyle(glassColorSystem.textSecondary())
                .fixedSize(horizontal: false, vertical: true)
            ...
            GlassButton("Manage Integrations", icon: "link", role: .primary) {
                withAnimation(GlassMotion.Easing.modalOpen) {
                    showIntegrationsDrawer = true
                }
            }
        }
    }
    ...
    var settingsSidebarGroups: [SettingsSidebarGroup] {
        [
            ...
            SettingsSidebarGroup(id: .integrations, entries: [.integrations])
        ]
    }
    ...
    enum SettingsEntry: String, CaseIterable, Identifiable {
        ...
        var subtitle: String? {
            ...
            case .integrations:
                return "Connect your favorite tools and services to FocusOS."
            }
        }
        ...
        var group: SettingsGroup {
            ...
            case .notion, .integrations: return .integrations
            }
        }
    }
