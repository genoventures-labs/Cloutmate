//
//  AppleRemindersPermissionDeniedDrawer.swift
//  FocusOS
//
//  Custom drawer alert for Apple Reminders permission denied
//

import SwiftUI
import AppKit

struct AppleRemindersPermissionDeniedDrawer: View {
    ...
    private var contentView: some View {
        VStack(alignment: .leading, spacing: 24) {
            VStack(alignment: .leading, spacing: 12) {
                Text("FocusOS needs permission to read your Apple Reminders.")
    ...
    private func openSystemSettings() {
        // Deep-link to Reminders privacy settings
