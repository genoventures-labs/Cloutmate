//
//  MentionDrawerView.swift
//  FocusOS
//
//  V2 drawer for @ mention autocomplete - matches SlashCommandDrawerView design
//
        ...
        VStack(spacing: 0) {
            ...
            HStack(spacing: 10) {
                ...
                if let filter = tabFilter {
                    Text("Mentions: \(WorkspaceObjectSearchService.shared.tabName(for: filter))")
            ...
            // Content - V2 polished mention rows
