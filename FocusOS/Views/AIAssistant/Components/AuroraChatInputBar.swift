...
struct AuroraChatInputBar: View {
    ...
    var onEmojiAutocompleteVisibilityChanged: ((Bool, [String], String?) -> Void)? = nil // Callback for emoji autocomplete
        ...
        ZStack {
            ...
            HStack(alignment: .center, spacing: 14) {
                AttachmentMenuView(
                    ...
                    onSelectScreenshot: onAttachScreenshot
                )
        ...
        VStack(alignment: .leading, spacing: 0) {
            MentionInputField(
                ...
                onEmojiAutocompleteVisibilityChanged: { visible, matchedEmojis, keyword in
                    onEmojiAutocompleteVisibilityChanged?(visible, matchedEmojis, keyword)
                }
            )
            .font(.system(size: 15))
    ...
    @ViewBuilder
    private func imageAttachmentPreview(
        image: ImageAttachmentService.ImageAttachment,
        title: String,
        subtitle: String,
