...
class QuickCaptureWindowController: ObservableObject {
    ...
    func show() {
        ...
        guard let container = try? ModelContainer(for: Schema([FocusOSShared.InboxItem.self, FocusOSShared.Task.self, FocusOSShared.Note.self, FocusOSShared.Post.self])) else {
