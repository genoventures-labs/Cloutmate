...
extension CalendarDayDetailDrawer.Item {
    ...
    static func post(_ post: FocusOSShared.Post) -> CalendarDayDetailDrawer.Item {
        let dateFormatter = DateFormatter()
    ...
    static func artifact(_ artifact: FocusOSShared.Artifact) -> CalendarDayDetailDrawer.Item {
        let dateFormatter = DateFormatter()
        dateFormatter.dateStyle = .medium
        dateFormatter.timeStyle = .short
    ...
    static func task(_ task: FocusOSShared.Task) -> CalendarDayDetailDrawer.Item {
        let dateFormatter = DateFormatter()
        dateFormatter.dateStyle = .medium
        dateFormatter.timeStyle = .short
