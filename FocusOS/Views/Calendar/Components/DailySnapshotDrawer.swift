...
struct DailySnapshotDrawer: View {
    ...
    @Query(sort: \FocusOSShared.Task.dueDate) private var allTasks: [FocusOSShared.Task]
    @Query(sort: \FocusOSShared.Artifact.createdAt, order: .reverse) private var allArtifacts: [FocusOSShared.Artifact]
    @Query(sort: \FocusOSShared.Project.dueDate) private var allProjects: [FocusOSShared.Project]
