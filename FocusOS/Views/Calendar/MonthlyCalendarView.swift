...
struct MonthlyCalendarView: View {
    ...
    @State private var postsForSelectedDate: [FocusOSShared.Post] = []
    ...
    private func postsForDate(_ date: Date) -> [FocusOSShared.Post] {
...
struct CalendarDayCell: View {
    ...
    private func colorForPost(_ post: FocusOSShared.Post) -> Color {
        return .kosmicBlue
    }
}
...
#Preview {
    ...
    @Previewable @State var selectedPost: FocusOSShared.Post? = nil
