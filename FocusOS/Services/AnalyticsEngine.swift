...
final class AnalyticsEngine {
    ...
    private let logger = Logger(subsystem: "com.kosmicapps.FocusOS", category: "Analytics")
    ...
    private func gatherEmotionalMetrics(
        ...
        // 4. Include Notes (from FocusOSShared)
    ...
    func backfillEmotionalData(modelContext: ModelContext) async {
        let logger = Logger(subsystem: "com.kosmicapps.FocusOS", category: "AnalyticsEngine")
