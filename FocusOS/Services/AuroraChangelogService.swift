...
actor AuroraChangelogService {
    ...
    private let lastSeenVersionKey = "com.kosmicapps.focusos.aurora.lastSeenVersion"
    private let lastSeenDateKey = "com.kosmicapps.focusos.aurora.lastSeenDate"
    ...
    private func parseGitLog(_ output: String) -> [GitCommit] {
        ...
        for line in output.components(separatedBy: .newlines) {
            ...
            if line.contains("|") && !line.hasPrefix(" ") && !line.hasPrefix("\t") {
                ...
                if !file.isEmpty && file.hasPrefix("FocusOS/") {
