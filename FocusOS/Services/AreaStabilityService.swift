...
final class AreaStabilityService {
    ...
    private let logger = Logger(subsystem: "com.kosmicapps.FocusOS", category: "AreaStability")
    ...
    private func calculateVariance(for area: Area, projects: [FocusOSShared.Project], modelContext: ModelContext) -> Double {
    ...
    private func getLinkedProjects(for area: Area, modelContext: ModelContext) -> [FocusOSShared.Project] {
        do {
